...
from .views import (
    ...
    AttachmentDownloadView, CategoryListView, ApplicationLogView, UserProjectViewSet
)
...
urlpatterns = [
    ...
    path('user/my-projects/', UserProjectViewSet.as_view({'get': 'my_projects'}), name='user-projects')
]
